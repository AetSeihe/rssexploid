...
<header class="header">
    ...
    <section class="main">
        <div class="main__container">
            ...
            <div class="error-404__back-btn">
                <a href="{{ URL::previous() }}">Вернуться назад</a>
            </div>
            <div class="error-404">404</div>
            <div class="info__error-404">
                <span class="highlight">Ошибка 404</span>
                Страница не найдена
                Неправильно набран адрес или такой
                страницы не существует
            </div>
            <div class="error-404__next-btn">
        ...
        <div class="bg">
            <div class="footer__container">
                <div class="footer-logo">
                    <a href="/" class="header__logo">Историк</a>
                    <span>© Istorik 2015-2022. All Rights Reserved</span>
                </div>
                <div class="footer-info">
                    ...
                    <div>
                        ...
                        <div class="fav-icons">
                            <a arget="_blanc" href="https://vk.com/istorikrf"><img src="{{asset('img/vk.svg')}}" alt="вконтакте"></a>
                            <a target="_blanc" href="https://t.me/istorikrf"><img src="{{asset('img/telegram.svg')}}" alt="телеграм"></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="popup__body">
            <div class="popup__content">
                ...
                <div class="popup__tittle">
                    <img src="{{asset('img/popup-icon-1.svg')}}" alt="">
                </div>
    ...
    <div class="popup" id="popupNeedSub">
        <div class="popup__body">
            <div class="popup__content">
                ...
                <div class="popup__text">
                    Оформите подписку для чтения материала
                </div>
            </div>
