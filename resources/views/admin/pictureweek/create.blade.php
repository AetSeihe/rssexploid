...
@section('title', 'Добавить картину')
...
@section('content')
    ...
    @endif
    <form action="{{ route('pictureweek.store') }}" method="POST">
        @csrf
        <div class="card card-body">
            <div class="form-group col-lg-4">
                <label for="inputDate">Порядковый номер недели года:</label>
                <input type="number" name="weeknumber" class="form-control" step="1" min="1" max="53">

            </div>
            <div class="form-group col-lg-4">
                <label for="feature_image">Изображение</label>
                <img src="" id="feature_image-upload" alt="" class="img-uploaded mb-1 w-100">
        ...
        <div class="form-group col-lg-12">
            ...
            <div class="form-group col-lg-12">
                ...
                <textarea name="anonce" cols="30" rows="10" class="editor"></textarea>
            </div>
            <div class="form-group col-lg-12">
